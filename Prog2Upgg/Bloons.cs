namespace Balloons
{
    ...
    {
        //tgus class has the purpose of spawning more bloons when this one dies
        private int health;
        ...
        // this overrides base method, so if the moab dies, it will spawn a red and a yellow bloon
